...
async function getCharcterFullById(AnimeId){
  return await animeRepository.getCharacterFullById(AnimeId);
}

async function getCharcterById(AnimeId){
  return await animeRepository.getCharacterById(AnimeId);
}
